...
> 一款漂亮、实用、中文化的 Telegram 服务器监控管理机器人。  
> 支持本机状态、服务器在线/离线监控、到期提醒、续费管理、价格备注管理、国家地区识别、国旗显示、流量/磁盘查看、事件记录、探针部署等功能。
...
可以通过一些 Telegram ID 查询机器人获取自己的数字 ID。
