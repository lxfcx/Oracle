...
# ===== USER PATCH: AI card layout + map/radar follow light/dark/solid/glass themes =====
_AI_MAP_THEME_CSS = r"""
/* ===== AI card layout + themed map/radar backgrounds ===== */

/* 普通指标行仍然不带独立背景，只融合在服务器卡片里 */
html body .metric-extra,
html body .metric-extra .mini:not(.ai-mini),
html body .metric-extra .mini:not(.ai-mini):nth-child(1),
html body .metric-extra .mini:not(.ai-mini):nth-child(2),
html body .metric-extra .mini:not(.ai-mini):nth-child(3),
html body .metric-extra .mini:not(.ai-mini):nth-child(4),
html body .metric-extra .mini:not(.ai-mini):nth-child(5),
html body .metric-extra .mini:not(.ai-mini):nth-child(6){
  background:transparent!important;
  background-color:transparent!important;
...
html.light body .metric-extra .ai-mini{
  ...
  background:linear-gradient(135deg,rgba(255,255,255,.62),rgba(219,234,254,.44),rgba(240,253,250,.38))!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.78),0 8px 22px rgba(37,99,235,.08)!important;
}
...
/* 实色背景模式 AI 卡片稍微实一点，透明玻璃模式保持轻透 */
html.solid body .metric-extra .ai-mini,
body.solid .metric-extra .ai-mini{
  background:linear-gradient(135deg,rgba(15,23,42,.52),rgba(30,41,59,.36),rgba(14,116,144,.20))!important;
  border-color:rgba(125,211,252,.24)!important;
}
html.light.solid body .metric-extra .ai-mini,
body.light.solid .metric-extra .ai-mini{
  background:linear-gradient(135deg,rgba(255,255,255,.90),rgba(239,246,255,.82),rgba(236,253,245,.72))!important;
  border-color:rgba(37,99,235,.15)!important;
}

/* 地图和雷达：不再固定黑底，跟随夜间/日间、实色/玻璃模式 */
html body .world-radar,
html body .topology-map{
  background:
    radial-gradient(circle at 73% 43%,rgba(34,197,94,.14),transparent 11%),
    radial-gradient(circle at 35% 42%,rgba(56,189,248,.10),transparent 36%),
    linear-gradient(135deg,rgba(15,23,42,.36),rgba(30,64,175,.22),rgba(14,116,144,.16))!important;
  border-color:rgba(255,255,255,.20)!important;
  box-shadow:inset 0 0 0 1px rgba(255,255,255,.05),0 14px 36px rgba(14,116,144,.12)!important;
}
html.light body .world-radar,
html.light body .topology-map{
  background:
    radial-gradient(circle at 73% 43%,rgba(34,197,94,.17),transparent 12%),
    radial-gradient(circle at 35% 42%,rgba(56,189,248,.18),transparent 36%),
    linear-gradient(135deg,rgba(255,255,255,.70),rgba(219,234,254,.58),rgba(224,242,254,.42))!important;
  border-color:rgba(37,99,235,.14)!important;
  box-shadow:inset 0 0 0 1px rgba(255,255,255,.70),0 14px 32px rgba(37,99,235,.10)!important;
}
html.solid body .world-radar,
body.solid .world-radar,
html.solid body .topology-map,
body.solid .topology-map{
  background:
    radial-gradient(circle at 73% 43%,rgba(34,197,94,.12),transparent 11%),
    radial-gradient(circle at 35% 42%,rgba(56,189,248,.09),transparent 34%),
    linear-gradient(135deg,rgba(15,23,42,.76),rgba(30,41,59,.70),rgba(12,74,110,.42))!important;
...
body.light.solid .topology-map{
  background:
    radial-gradient(circle at 73% 43%,rgba(34,197,94,.16),transparent 12%),
    radial-gradient(circle at 35% 42%,rgba(56,189,248,.15),transparent 36%),
    linear-gradient(135deg,rgba(255,255,255,.94),rgba(239,246,255,.86),rgba(224,242,254,.70))!important;
}

/* 世界地图轮廓也跟随日夜颜色 */
html body .world-outline path,
html body .world-outline polygon,
html body .world-outline .landmass{
  fill:rgba(96,165,250,.16)!important;
  stroke:rgba(191,219,254,.42)!important;
}
html.light body .world-outline path,
html.light body .world-outline polygon,
html.light body .world-outline .landmass{
  fill:rgba(59,130,246,.16)!important;
  stroke:rgba(37,99,235,.30)!important;
}
html.solid body .world-outline path,
html.solid body .world-outline polygon,
body.solid .world-outline path,
body.solid .world-outline polygon{
  fill:rgba(96,165,250,.13)!important;
  stroke:rgba(148,163,184,.42)!important;
}
html.light.solid body .world-outline path,
html.light.solid body .world-outline polygon,
body.light.solid .world-outline path,
body.light.solid .world-outline polygon{
  fill:rgba(59,130,246,.14)!important;
  stroke:rgba(30,64,175,.28)!important;
}

/* 攻击流量雷达圆圈和中间数字：跟随主题，不再黑底 */
html body .radar{
  background:
    conic-gradient(#22c55e var(--risk),rgba(255,255,255,.16) 0),
    repeating-radial-gradient(circle,transparent 0 21px,rgba(191,219,254,.18) 22px 23px),
    radial-gradient(circle,rgba(15,23,42,.25),rgba(14,116,144,.12))!important;
  box-shadow:0 0 28px rgba(34,197,94,.18)!important;
}
html body .radar span{
  background:linear-gradient(135deg,rgba(15,23,42,.36),rgba(14,116,144,.24))!important;
  color:#f8fbff!important;
  -webkit-text-fill-color:#f8fbff!important;
...
html.light body .radar{
  background:
    conic-gradient(#16a34a var(--risk),rgba(37,99,235,.12) 0),
    repeating-radial-gradient(circle,transparent 0 21px,rgba(37,99,235,.18) 22px 23px),
    radial-gradient(circle,rgba(255,255,255,.82),rgba(219,234,254,.50))!important;
  box-shadow:0 0 24px rgba(37,99,235,.14)!important;
}
html.light body .radar span{
  background:linear-gradient(135deg,rgba(255,255,255,.86),rgba(219,234,254,.66))!important;
  color:#0f172a!important;
  -webkit-text-fill-color:#0f172a!important;
  text-shadow:none!important;
}
html.solid body .radar,
body.solid .radar{
  background:
    conic-gradient(#22c55e var(--risk),rgba(148,163,184,.16) 0),
    repeating-radial-gradient(circle,transparent 0 21px,rgba(148,163,184,.18) 22px 23px),
    radial-gradient(circle,rgba(15,23,42,.78),rgba(30,41,59,.54))!important;
}
html.light.solid body .radar,
body.light.solid .radar{
  background:
    conic-gradient(#16a34a var(--risk),rgba(37,99,235,.10) 0),
    repeating-radial-gradient(circle,transparent 0 21px,rgba(37,99,235,.15) 22px 23px),
    radial-gradient(circle,rgba(255,255,255,.94),rgba(239,246,255,.80))!important;
}
html.solid body .radar span,
body.solid .radar span{
...
html.light.solid body .radar-legend b,
body.light.solid .radar-legend b{
  background:rgba(255,255,255,.82)!important;
}
html.solid body .radar-legend b,
body.solid .radar-legend b{
  background:rgba(15,23,42,.34)!important;
}
/* ===== end AI card layout + themed map/radar backgrounds ===== */
"""

def _apply_ai_map_theme_patch():
    global BASE
    if 'AI card layout + themed map/radar backgrounds' not in BASE:
        BASE = BASE.replace('</style><script>', _AI_MAP_THEME_CSS + '</style><script>')
...
# ===== STRICT FIX ONLY: WebSocket/SSE lamp + AI fault card =====
_STRICT_LAMP_AI_CSS = r"""
/* ===== strict fix only: live lamp + AI fault card ===== */

/* 1) WebSocket / SSE 0刷新状态灯：真实元素 + 强制可见 */
[data-neon-live]{
  display:inline-flex!important;
  align-items:center!important;
  gap:8px!important;
}
[data-neon-live] .strict-live-lamp{
  ...
  animation:strictLampAmber 1.35s ease-in-out infinite!important;
  vertical-align:middle!important;
}
[data-neon-live].strict-ws .strict-live-lamp{
  background:#22c55e!important;
  box-shadow:0 0 10px rgba(34,197,94,1),0 0 28px rgba(34,197,94,.58)!important;
  animation:strictLampGreen 1.35s ease-in-out infinite!important;
}
[data-neon-live].strict-sse .strict-live-lamp{
  background:#facc15!important;
  box-shadow:0 0 10px rgba(250,204,21,1),0 0 28px rgba(250,204,21,.58)!important;
  animation:strictLampYellow 1.35s ease-in-out infinite!important;
}
[data-neon-live].strict-bad .strict-live-lamp{
  background:#ef4444!important;
  box-shadow:0 0 10px rgba(239,68,68,1),0 0 28px rgba(239,68,68,.60)!important;
  animation:strictLampRed 1.35s ease-in-out infinite!important;
}
@keyframes strictLampGreen{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.16);opacity:.96}}
@keyframes strictLampYellow{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.14);opacity:.96}}
@keyframes strictLampAmber{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.14);opacity:.96}}
@keyframes strictLampRed{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.14);opacity:.96}}

/* 2) AI 故障判断：只影响 ai-mini，不影响其它指标行 */
html body .metric-extra .ai-mini,
html body .servercard .metric-extra .ai-mini,
html body .card .metric-extra .ai-mini,
html body div.metric-extra > div.ai-mini{
...
_STRICT_LAMP_AI_JS = r"""
<script>
(function(){
  function stateFromText(t){
    t = (t || '').replace(/\s+/g,' ');
    if(/WebSocket/i.test(t)) return 'strict-ws';
    if(/\bSSE\b/i.test(t)) return 'strict-sse';
    if(/轮询|回退|失败|断开|错误|异常/i.test(t)) return 'strict-bad';
    return 'strict-connecting';
  }

  function fixLiveLamp(){
    var chip = document.querySelector('[data-neon-live]');
    if(!chip) return;
    var lamp = chip.querySelector('.strict-live-lamp');
    if(!lamp){
      lamp = document.createElement('span');
      lamp.className = 'strict-live-lamp';
      chip.insertBefore(lamp, chip.firstChild);
    }
    chip.classList.remove('strict-ws','strict-sse','strict-bad','strict-connecting');
    chip.classList.add(stateFromText(chip.textContent || ''));
  }

  function forceAiLayout(){
    document.querySelectorAll('.metric-extra .ai-mini').forEach(function(box){
...
def _apply_strict_lamp_ai_fix():
    global BASE
    if 'strict fix only: live lamp + AI fault card' not in BASE:
        BASE = BASE.replace('</style><script>', _STRICT_LAMP_AI_CSS + '</style><script>')
    if 'strict-live-lamp' not in BASE:
        BASE = BASE.replace('</script></head><body>', '</script>' + _STRICT_LAMP_AI_JS + '</head><body>')
...
# ===== USER PATCH: compact view independent expand, no top-right circle mark =====
_COMPACT_INDEPENDENT_EXPAND_CSS = r"""
/* ===== compact independent expand, no top-right info circle ===== */
.compact-mini-card .compact-info{display:none!important}
.compact-mini-card .compact-top{justify-content:flex-start!important}
.compact-mini-card .compact-detail{
  margin-top:10px!important;
  padding-top:10px!important;
  border-top:1px solid rgba(15,23,42,.18)!important;
  display:block!important;
}
.compact-mini-card .compact-detail.hidden{display:none!important}
...
.compact-detail-section .compact-detail-line{
  display:flex!important;
  justify-content:space-between!important;
  gap:8px!important;
...
.compact-detail-section .compact-detail-line b{
  color:#334155!important;
  -webkit-text-fill-color:#334155!important;
  font-weight:1000!important;
}
.compact-detail-section .compact-detail-line span{
  text-align:right!important;
  min-width:0!important;
  overflow:hidden!important;
  text-overflow:ellipsis!important;
}
.compact-detail-section .metric-extra{
  margin-top:4px!important;
}
.compact-detail-section .metric-extra .mini{
  color:#0f172a!important;
  -webkit-text-fill-color:#0f172a!important;
}
.compact-mini-card .compact-detail-actions{
  display:flex!important;
  justify-content:flex-end!important;
  gap:7px!important;
  margin-top:8px!important;
}
.compact-mini-card .compact-detail-actions button,
.compact-mini-card .compact-detail-actions .btn{
  padding:5px 8px!important;
  font-size:12px!important;
  border-radius:9px!important;
}
html.light .compact-mini-card .compact-detail{
  border-top-color:rgba(37,99,235,.13)!important;
}
html.light .compact-detail-section{
  border-color:rgba(37,99,235,.12)!important;
  background:linear-gradient(135deg,rgba(255,255,255,.62),rgba(219,234,254,.38))!important;
}
.compact-mini-card .compact-actions button[data-compact-toggle]{
  min-width:46px!important;
}
/* ===== end compact independent expand ===== */
"""

_COMPACT_INDEPENDENT_EXPAND_JS = r"""
<script>
(function(){
  window.toggleCompactDetail=function(id){
    document.querySelectorAll('[data-compact-detail="'+id+'"]').forEach(function(panel){
      panel.classList.toggle('hidden');
    });
    var panel=document.querySelector('[data-compact-detail="'+id+'"]');
    var open=panel && !panel.classList.contains('hidden');
    document.querySelectorAll('[data-compact-toggle="'+id+'"]').forEach(function(btn){
      btn.textContent=open?'收回':'展开';
    });
  };
})();
</script>
...
def _compact_cards_view_html_independent():
    return """<div data-view-compact class="hidden compact-list compact-cardgrid-view">{% for s in data.servers %}{% set m=s.metrics %}
<div class="compact-server compact-mini-card {{server_card_class(s)}}">
  <div class="compact-top">
    <div class="compact-title">{{flag_icon(s)|safe}}<span data-live-dot="{{s.id}}" class="dot {{'online' if s.online else 'offline'}}"></span><span class="name">{{s.name}}</span></div>
  ...
  <div class="compact-detail hidden" data-compact-detail="{{s.id}}">
    <div class="compact-detail-panel">
      <div class="compact-detail-section">
        <h4>🧾 基础信息</h4>
        <div class="compact-detail-line"><b>ID</b><span>{{s.id}}</span></div>
        <div class="compact-detail-line"><b>主机</b><span>{{s.host}}:{{s.check_port}}</span></div>
        <div class="compact-detail-line"><b>地区</b><span>{{s.location_cn or s.location}}</span></div>
        <div class="compact-detail-line"><b>系统</b><span>{{s.os_name or '未知系统'}}</span></div>
      </div>
      <div class="compact-detail-section">
        <h4>📊 资源</h4>
        {{progress_row('CPU',s.id,'cpu',m.cpu_percent or 0,s.cpu_alert or 90)|safe}}
      ...
      <div class="compact-detail-section">
        <h4>🤖 AI 故障判断</h4>
        <div data-ai="{{s.id}}">{{ai_fault_html(s)}}</div>
      </div>
      <div class="compact-detail-section">
        <h4>📝 备注</h4>
        <div class=small>{{s.note or '无备注'}}｜数据：{{m.updated_at or '未知'}}</div>
      </div>
    </div>
  </div>
  <div class="compact-actions">
    <button type=button data-compact-toggle="{{s.id}}" onclick="toggleCompactDetail('{{s.id}}')">展开</button>
    <a class=btn href="/servers/{{s.id}}">详情</a>
  </div>
</div>{% else %}<div class=card>📭 暂无服务器</div>{% endfor %}</div>"""

def _replace_compact_block_independent(template):
    new_block = _compact_cards_view_html_independent()
    # 兼容此前两种紧凑视图块
    template = re.sub(
        r'<div data-view-compact class="hidden compact-list compact-cardgrid-view">.*?(?=<div data-view-table class=hidden>)',
        new_block,
        template,
        count=1,
        flags=re.S
...
def _apply_compact_independent_expand_patch():
    global BASE, DASH, SERVERS
    if 'compact independent expand, no top-right info circle' not in BASE:
        BASE = BASE.replace('</style><script>', _COMPACT_INDEPENDENT_EXPAND_CSS + '</style><script>')
    if 'toggleCompactDetail' not in BASE:
        BASE = BASE.replace('</body></html>', _COMPACT_INDEPENDENT_EXPAND_JS + '</body></html>')
    DASH = _replace_compact_block_independent(DASH)
